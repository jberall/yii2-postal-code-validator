 ...
 * We modified it to work with Yii2 Validation.
 * @url https://github.com/sirprize/postal-code-validator
...
class PostalCodeValidation extends Validator
{
    ...
    public function isValid($countryCode, $postalCode, $ignoreSpaces = false)
    {
        ...
        {
            throw new NotFoundHttpException;(sprintf('Invalid country code: "%s"', $countryCode));
        }
